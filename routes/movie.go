...
func MovieRoutes(e *echo.Group) {
	...
	e.POST("/movie", middleware.UploadTrailer(middleware.UploadThumbnail(h.CreateMovie)))
	e.PATCH("/movie/:id", middleware.UploadTrailer(middleware.UploadThumbnail(h.UpdateMovie)))
